...
def display_output(pic1, kpt1, pic2, kpt2, best_match):
    ...
    output_image = cv2.drawMatches(
        pic1, kpt1, pic2, kpt2, best_match, None, matchColor=(255, 0, 0), flags=2)
    # cv2.imshow('Output image', output_image)
    cv2.imwrite('matching_reference.png', output_image)


# main function
if __name__ == '__main__':
    # giving the path of both of the images
    first_image_path = 'images/I1.jpg'
    second_image_path = 'images/I2.jpg'
